...
public class MedicalNoteExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        ...
        log.error(errorMessage);
        return buildResponseEntity(new MedicalNoteError(NOT_FOUND, errorMessage));
    }
    ...
    protected ResponseEntity<Object> handleMethodArgumentNotValid(MethodArgumentNotValidException ex, HttpHeaders headers, HttpStatus status, WebRequest request) {
        MedicalNoteError medicalNoteError = new MedicalNoteError();
        medicalNoteError.setStatus(BAD_REQUEST);
        ...
        medicalNoteError.setMessage(message.toString());
